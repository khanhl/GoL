...
namespace GameOfLife.GameCoreLib
{
    public class Row
    {
        ...
        public void InsertCell(int index, Cell cell, int count)
        {
            if (index < 0 || index >= count) throw new ArgumentOutOfRangeException("Invalid Index value: must be greater than zero and less than Column count");
